...
CREATE TABLE audit_log (
        ...
        action_type varchar(255) check (action_type in ('CREATE','UPDATE','DELETE','VIEW','LOGIN','LOGOUT','PAYMENT','ORDER','CANCEL')),
        entity_id bigint,
...
CREATE TABLE daily_operation_tracker (
        operation_id integer,
        created_at timestamp,
        is_editing boolean not null,
        last_edit_started timestamp,
...
CREATE TABLE invoice (
        ...
        payment_status varchar(255) check (payment_status in ('PENDING','PAID','FAILED','REFUNDED','CANCELLED')),
        transaction_id varchar(255),
        order_id bigint not null unique,
        primary key (invoice_id)
    );
INSERT INTO invoice VALUES(1,1751099820086,'Order #1',NULL,NULL,'PENDING',NULL,1);
INSERT INTO invoice VALUES(2,1751100722459,'Order #2',NULL,NULL,'PENDING',NULL,2);
INSERT INTO invoice VALUES(3,1751103252708,'Order #3',NULL,NULL,'PENDING',NULL,3);
INSERT INTO invoice VALUES(4,1751103628441,'Order #4',NULL,NULL,'PENDING',NULL,4);
INSERT INTO invoice VALUES(5,1751103729000,'Order #5',NULL,NULL,'PENDING',NULL,5);
CREATE TABLE lp (
        artist varchar(255),
...
INSERT INTO product VALUES('book',1,'978-0-7432-7356-5','New',1751074513000,'20x13x2 cm','https://covers.openlibrary.org/b/id/8225261-L.jpg','2024-01-15','A classic American novel about the Jazz Age and the American Dream.',120000,24,0,'The Great Gatsby',1751103729003,0.30000001192092895507);
INSERT INTO product VALUES('book',2,'978-0-06-112008-4','New',1751074513000,'21x14x2.5 cm','https://covers.openlibrary.org/b/id/8226816-L.jpg','2024-01-10','A gripping tale of racial injustice and childhood innocence in the American South.',135000,25,0,'To Kill a Mockingbird',1751103729003,0.34999999403953552246);
INSERT INTO product VALUES('book',3,'978-0-452-28423-4','New',1751074513000,'20x13x2 cm','https://covers.openlibrary.org/b/id/8226112-L.jpg','2024-01-12','A dystopian social science fiction novel about totalitarianism.',145000,36,1,'1984',1751103628447,0.2800000011920928955);
INSERT INTO product VALUES('cd',4,'094638241621','New','2025-06-28 08:35:13','14x12x1 cm','https://upload.wikimedia.org/wikipedia/en/4/42/Beatles_-_Abbey_Road.jpg','2024-01-20','The Beatles final studio album featuring Come Together.',350000,15,0,'Abbey Road','2025-06-28 08:35:13',0.10000000000000000555);
INSERT INTO product VALUES('cd',5,'094637420621','New','2025-06-28 08:35:13','14x12x1 cm','https://upload.wikimedia.org/wikipedia/en/3/3b/Dark_Side_of_the_Moon.png','2024-01-18','Pink Floyd masterpiece exploring conflict and madness.',380000,20,1,'Dark Side of the Moon','2025-06-28 08:35:13',0.10000000000000000555);
...
INSERT INTO user VALUES(2,'manager1@itss.com',1,'Manager User 1','hashedpassword456','0987654321','2025-06-28 08:35:13','MANAGER',0.0);
